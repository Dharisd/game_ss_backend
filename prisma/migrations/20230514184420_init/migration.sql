...
INSERT INTO "new_RegistrationRequest" ("dob", "email", "faculty", "id", "name", "nid", "payment_slip", "phone_number") SELECT "dob", "email", "faculty", "id", "name", "nid", "payment_slip", "phone_number" FROM "RegistrationRequest";
